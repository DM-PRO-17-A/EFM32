...
int main() {
  ...
  GPIO->P[GPIO_E].DOUTSET = (0 << AIN2);
  GPIO->P[GPIO_A].DOUTSET = (1 << BIN1);            // Turn on BIN1 (PE0)
  GPIO->P[GPIO_A].DOUTSET = (0 << BIN2);
  ...
  while(1) {
	TIMER0->CC[0].CCVB = 500;
	TIMER3->CC[2].CCVB = 500;
	Delay(200);										  // Supposed to be in ms?
	TIMER0->CC[0].CCVB = 0;
	TIMER3->CC[2].CCVB = 0;
	Delay(100);
//	GPIO->P[GPIO_E].DOUTTGL = (1 << AIN1);
//	GPIO->P[GPIO_E].DOUTTGL = (1 << AIN2);
//	TIMER3->CC[2].CCVB = 500;
//	Delay(200);
//	TIMER3->CC[2].CCVB = 0;
//	Delay(100);
